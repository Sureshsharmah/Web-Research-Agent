...
if "target_word_count" not in st.session_state:
    st.session_state.target_word_count = 1000 
...
def generate_pdf(query, data, summary, deep_research=False):
    ...
    # Cover Page
    story.append(Paragraph("Web Research Agent", styles['Title']))
...
st.sidebar.write("Dual-agent system using OpenAI and Tavily for research and OpenRouter for drafting with the model of your choosing.")
